...
struct ContentView: View {
    ...
    private func clearConversationText() {
        // Clear displayed conversation text for privacy when app goes to background
        // This ensures users don't see previous conversations when returning to the app,
        // reinforcing our privacy policy that conversations are not stored
        transcribedText = ""
        translatedText = ""
        
        // Also reset any error states that might be showing
        showError = false
        errorMessage = ""
        
        print("🔒 Privacy: Cleared conversation text from display")
    }
